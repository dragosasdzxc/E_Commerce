...
namespace E_Commerce.Models.Config.Map
{
    public class CategoryMapper
    {
        ...
        {
            //cấu hình mapper
            var config = new MapperConfiguration(cfg => cfg.CreateMap<category_view, category>());
            //khai báo mapper
        ...
        public Mapper FromEntitiesToView()
        {
            ...
            //cấu hình mapper
            var config = new MapperConfiguration(cfg => cfg.CreateMap<category, category_view>());
            //khai báo mapper
            var mapper = new Mapper(config);
            return mapper;
        }
